...
export type INftContract = nearAPI.Contract & {
  ...
  collection_set_like: ({ collection_id }: { collection_id: string }, gas: string, deposit?: string) => Promise<any>;
    collection_set_view: ({ collection_id }: { collection_id: string }, gas?: string, price?: string) => Promise<any>;
    nft_mint: (data: any) => Promise<any>;
  follow_artist_account: ({ account_id }: { account_id: string }, gas: string, deposit?: string) => Promise<any>;
  view_artist_account: ({ account_id }: { account_id: string }, gas: string, deposit?: string) => Promise<any>;
  token_set_view: ({ token_id }: { token_id: string }, gas: string, deposit?: string) => Promise<any>;
