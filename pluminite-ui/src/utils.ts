...
export type INftContract = nearAPI.Contract & {
    ...
    nft_tokens_by_filter: ({ catalog, page_index, page_size, sort, account_id, is_for_sale, owner_id, is_liked, is_followed, is_active_bid}: { catalog: string | null, page_index: number, page_size: number, sort: number, account_id:string, is_for_sale?: boolean | null, owner_id?: string | null, is_liked?: boolean | null, is_followed?: boolean | null, is_active_bid?: boolean | null }) => Promise<Array<ITokenResponseItem>>;
    sale_history: ({ token_id, page_index, page_size, asked_account_id}: { token_id: string, page_index: number, page_size: number, asked_account_id: string }) => Promise<Array<any>>;
    ...
    sale_offer: ({ token_id, time, offer} : { token_id: string, time: any, offer?: string}) => Promise<any>;
