...
interface IMarketContractContextProviderState {
    minStorage: object | null;
}

export class MarketContractContextProvider extends Component<IMarketContractContextProvider, IMarketContractContextProviderState> {
    public state = {
        minStorage: null,
    };

    constructor(props: IMarketContractContextProvider) {
        super(props);
    }

    private get marketContract() {
    ...
    public render() {
        const value = {
            ...
            marketContract: this.marketContract,
        ...
        return (
            <NftContractContext.Consumer>
                { nftContract => (
                    <MarketContractContext.Provider value={value}>
                        {this.props.children}
